        ...
        <div className={"w-full pt-24"}>
            ...
            <div>
                <p className="p-6 md:py-8 md:px-[15%] hyphens-manual">
                    ...
                    Berufsrecht: Gewerbeordnung (GewO), abrufbar unter: <a className={"underline hover:text-orange-accent"} href="http://www.ris2.bka.gv.at">http://www.ris2.bka.gv.at</a>
                ...
                <p className="p-6 md:py-8 md:px-[15%] hyphens-manual">
                    ...
                    <a className={"underline hover:text-orange-accent"} href="https://toni-navigation.at/agbs">Allgemeine Geschäftsbedingungen</a><br/>
                        ...
                        <a className={"underline hover:text-orange-accent"} href="https://toni-navigation.at/app-datenschutz">Datenschutz Richtlinien</a><br/>
